...
public:
	...
	const String instructions = "Accepted Commands:\n--audio <file to read>\n";
    ...
    */
    ...
    {
    public:
        MainWindow (String name, Clara *clara)  : DocumentWindow (name,
                                                    Colours::lightgrey,
                                                    DocumentWindow::allButtons)
        {
            setUsingNativeTitleBar (true);
			setContentOwned(new MainContentComponent(clara), true);
...
START_JUCE_APPLICATION (ClaraApplication)
